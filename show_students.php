	...
	<section id="header">
		<div class="row">  
			...
			<div class="col-md-10" style="text-align: right;color: #FFD700;"> 
                ...
                <a href="index2.php" style="margin-left: 20px;">  Delete </a> 				
			</div>
		</div>
	</section>
	
	<section id = "section2">
		<div class="title" style="color: #FAFAD2" > Lawyers List </div>
		<div style="margin-left:20%; margin-right:20%; margin-top:80px; margin-bottom:80px;text-align:center;background:#E0FFFF;">
			<div class="row" style="padding:5px;"> 
				<div class="col-md-2" style="color:#5C2C26 ; font-size: 20px">  ID  </div>
				<div class="col-md-2" style="color:#5C2C26 ; font-size: 20px">  Name </div>
				<div class="col-md-2" style="color:#5C2C26 ; font-size: 20px">  Position  </div>
				<div class="col-md-2" style="color:#5C2C26 ; font-size: 20px">  Expertise </div>
				<div class="col-md-2" style="color:#5C2C26 ; font-size: 20px">  Salary </div>
				<div class="col-md-2" style="color:#5C2C26 ; font-size: 20px">  LeaderID </div>
			</div>
